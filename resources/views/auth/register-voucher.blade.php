    ...
    <div class="form-wrapper m-auto">
      <div class="form-container my-4">
        ...
        <div class="panel">
          ...
          <p class="text-muted text-center">if there is fraud when using this application, your account will be permanently blocked</p>
          ...
          <form class="register-form" action="{{ route('register') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <input type="text" class="form-control @error('voucher') is-invalid @enderror" id="_voucher" name="voucher" value="{{ $voucher }}" readonly>
              @error('voucher')
            ...
            <div class="form-group">
              <input type="text" class="form-control @error('code') is-invalid @enderror" id="_code" name="code" placeholder="unique code" value="{{ old("code") }}">
              @error('code')
              <div class="invalid-feedback text-left">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="avatar online mb-4">
              <img id="image_preview" src="{{ asset("dist/img/logo.png") }}" class="img-fluid rounded-circle" alt="avatar">
            </div>
            <button type="submit" class="btn btn-success btn-block">Sign up</button>
            <p class="text-muted text-center mt-3 mb-0">
              By signing up, you agree to our <a class="external" href="{{ route("rule") }}" target="_blank">terms of use</a>.
            </p>
          </form>
