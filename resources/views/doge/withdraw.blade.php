        ...
        <form method="POST" action="{{ route("doge.withdraw.store") }}">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <small id="emailHelp" class="form-text text-muted">minimum withdraw 10 doge, fee for outward application is 5 doge, if withdraw more then 500 doge fee is 2%.</small>
              @error("amount")
